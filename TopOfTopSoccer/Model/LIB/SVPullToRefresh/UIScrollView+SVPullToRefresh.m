...
- (void)layoutSubviews {
    ...
    if(hasCustomView) {
        ...
        CGRect Size = [self.titleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil];
        CGSize titleSize = CGSizeMake(Size.size.width, Size.size.height);
        
//        CGSize titleSize = [self.titleLabel.text sizeWithFont:self.titleLabel.font
//                                            constrainedToSize:CGSizeMake(labelMaxWidth,self.titleLabel.font.lineHeight)
//                                                lineBreakMode:self.titleLabel.lineBreakMode];
        
        NSDictionary *attributes1 = @{NSFontAttributeName:self.subtitleLabel.font};
        CGRect Size1 = [self.subtitleLabel.text boundingRectWithSize:CGSizeMake(labelMaxWidth,self.subtitleLabel.font.lineHeight) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes1 context:nil];
        CGSize subtitleSize = CGSizeMake(Size1.size.width, Size1.size.height);
